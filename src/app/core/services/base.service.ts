...
export abstract class BaseService<T> {
  ...
  console.log("get all");
    return this.http.get<T[]>(this.getServiceUrl()+'/getAll', {params: params});
  }
  ...
  public insert(data: T): Observable<T> {
	console.log("insert command:"+JSON.stringify(data));
	
    return this.http.post<T>(this.getServiceUrl()+'/insert', JSON.stringify(data), {headers: this.getHttpHeaders()});
  }
